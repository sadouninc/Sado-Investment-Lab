...
class PolicyLeadTimeAIDCTests(unittest.TestCase):
    ...
    def test_canonical_ai_dc_raw_and_reliable_dates_are_separated(self):
        ...
        self.assertEqual(evaluation["raw_first"]["inflow_date"], "2024-09-26")
        self.assertEqual(evaluation["raw_first"]["warming_date"], "2024-11-05")
        self.assertEqual(evaluation["reliable_first"]["warming_date"], "2024-11-06")
        self.assertEqual(evaluation["reliable_first"]["inflow_date"], "2024-11-08")
    ...
    def test_policy_deltas_preserve_v1_and_add_reliable_dates(self):
        result = build_ai_dc_policy_lead_time_v2(history=self.history, v1_lead_time=self.v1)
        evaluation = result["evaluation"]
        self.assertEqual(evaluation["raw_first"]["policy_to_inflow_days"], -8)
        self.assertEqual(evaluation["raw_first"]["policy_to_warming_days"], 32)
        self.assertEqual(evaluation["reliable_first"]["policy_to_warming_days"], 33)
        self.assertEqual(evaluation["reliable_first"]["policy_to_inflow_days"], 35)
