...
class PolicyLeadTimeAIDCTests(unittest.TestCase):
    ...
    def build(self):
        return build_ai_dc_policy_lead_time_v2(
            history=self.history,
            v1_lead_time=self.v1,
    ...
    def test_without_explicit_theme_config_does_not_infer_retrospective_membership(self):
        result = build_ai_dc_policy_lead_time_v2(history=self.history, v1_lead_time=self.v1)
        self.assertNotIn("RETROSPECTIVE_MEMBERSHIP", result["evaluation"]["limitations"])
