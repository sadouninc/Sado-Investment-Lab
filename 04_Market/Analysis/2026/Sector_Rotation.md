...
<div id="sector-rotation-summary" class="notice-card" aria-live="polite">
  <strong>Sector canonical historyを確認中...</strong>
</div>
...
(() => {
  ...
  function render(rows) {
    ...
    summary.innerHTML = `<strong>Latest confirmed: ${esc(newest)}</strong>`
      + `<p>TOPIX-17 Sector ${latest.length}件 / WARMING・INFLOW ${early.length}件 / 新しいstate遷移 ${transitions.length}件。</p>`;
